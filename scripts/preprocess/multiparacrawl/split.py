...
m2m_languages = {'bg', 'cs', 'da', 'de', 'el', 'es', 'et', 'fi', 'fr', 'hu', 'it',
...
flangdirs = sorted(glob.glob(f"./MultiParaCrawl/tmp/*"))
for flangdir in flangdirs:
  langpair = flangdir.split('/')[-1]
  ...
  if src_lang == 'en' or tgt_lang == 'en':
      name = "ParaCrawl"
  src_file = "{}/{}.{}-{}.{}".format(data_dir, name, src_lang, tgt_lang, src_lang)
  tgt_file = "{}/{}.{}-{}.{}".format(data_dir, name, src_lang, tgt_lang, tgt_lang)
