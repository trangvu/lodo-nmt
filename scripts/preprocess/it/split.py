...
flangdirs = sorted(glob.glob(f"./it/tmp/*"))
for flangdir in flangdirs:
  ...
  src_file = "{}/corpus.{}-{}.{}".format(data_dir, src_lang, tgt_lang, src_lang)
  tgt_file = "{}/corpus.{}-{}.{}".format(data_dir, src_lang, tgt_lang, tgt_lang)
